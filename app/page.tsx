  ...
  return (
    <main className="marketing-page">
      <nav className="marketing-nav">
        ...
        <div className="marketing-nav-links"><a href="#como-funciona">Como funciona</a><a href="#para-sua-loja">Para sua loja</a><a href="#duvidas">Dúvidas</a></div>
      ...
      <section className="marketing-hero">
        <div className="marketing-hero-copy">
          ...
          <div className="marketing-hero-actions"><Link className="marketing-button marketing-button-gold" href="/signup">Começar teste grátis <Arrow /></Link><a className="marketing-text-link" href="#como-funciona">Entender a plataforma <span>↓</span></a></div>
        ...
        <div className="marketing-hero-visual" aria-label="Exemplo de cartão Fidelizarei">
          <div className="marketing-orbit marketing-orbit-one" /><div className="marketing-orbit marketing-orbit-two" />
          <div className="marketing-phone"><div className="marketing-phone-notch" /><div className="marketing-phone-top"><span>9:41</span><b>● ● ●</b></div><div className="marketing-wallet-label">na sua carteira</div><div className="marketing-pass-card"><div className="marketing-pass-head"><img src="/logo-fidelizarei-transparent.png" alt="" /><span>CAFÉ PORTUGAL</span></div><small>PROGRAMA DE FIDELIDADE</small><strong>7 cafés<br />e o próximo é seu.</strong><div className="marketing-pass-dots"><i className="done" /><i className="done" /><i className="done" /><i /><i /><i /><i /></div><div className="marketing-pass-bottom"><span>3 DE 7 PONTOS</span><b>ATIVO</b></div></div><div className="marketing-phone-bottom">⌁</div></div>
          <div className="marketing-scan-chip"><span>⌘</span><div><small>APONTE A CÂMERA</small><b>Escaneie e pontue</b></div></div>
        </div>
      </section>

      <section className="marketing-proof"><p>FEITO PARA NEGÓCIOS QUE ATENDEM TODOS OS DIAS</p><div className="marketing-segments"><span><b>☕</b> PADARIAS</span><span><b>⌑</b> RESTAURANTES</span><span><b>✦</b> LAVA-JATOS</span><span><b>✂</b> SALÕES</span><span><b>◇</b> LOJAS</span></div></section>

      <section className="marketing-problem" id="para-sua-loja">
      ...
      <footer className="marketing-footer">
        <div className="marketing-footer-main">
          <div className="marketing-footer-brand"><img src="/logo-fidelizarei-transparent.png" alt="Fidelizarei" /><p>Fidelidade digital para negócios que querem clientes voltando sempre.</p><a className="marketing-footer-instagram" href="https://www.instagram.com/fidelizarei/" target="_blank" rel="noreferrer">◉ @fidelizarei</a></div>
          <div className="marketing-footer-column"><strong>Plataforma</strong><a href="#como-funciona">Como funciona</a><a href="#recursos">Recursos</a><Link href="/signup">Criar conta</Link></div>
          <div className="marketing-footer-column"><strong>Atendimento</strong><a href="https://wa.me/5571982185663?text=Olá!%20Quero%20conhecer%20a%20Fidelizarei." target="_blank" rel="noreferrer">Falar no WhatsApp</a><a href="#duvidas">Perguntas frequentes</a><a href="mailto:contato@fidelizarei.com.br">contato@fidelizarei.com.br</a></div>
        </div>
        <div className="marketing-footer-bottom"><span>© {new Date().getFullYear()} Fidelizarei. Todos os direitos reservados.</span><div><a href="/">Política de privacidade</a><a href="/">Termos de uso</a></div></div>
      </footer>
    </main>
  );
}
